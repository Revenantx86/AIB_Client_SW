...
/*
 *  LookUp table for handling incoming data
 */
//
void handleCommand(QString inputData, Ui::MainWindow *targetUI)
{
    QStringList dataList = inputData.split(" ");


}

void setupCustomPlot(Ui::MainWindow *ui)
{
    /*
    int verticalMin = 100;
    int verticalMax = 300;
    ...
    ui->customPlot->yAxis->setLabel("Random wobbly Temperature lines value");
...
void setupWidgetCustomPlot(Ui::PlottingWindow *ui)
{
}
